...
- Some deferred UI items are stale: `OrbitColorPicker`, `OrbitContextMenu`, and `OrbitResizable` now exist in `@layera-labs/orbit-ui`, though context menu/resizable are not clearly integrated into the editor surface.
