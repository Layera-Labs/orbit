 ...
 * through a `GainNode`. Gain comes from `sampleVolume` in `@layera-labs/orbit-video` — the
 ...
 */
import { curvePoints, sampleVolume, type AudioTrackClip } from '@layera-labs/orbit-video/browser';
