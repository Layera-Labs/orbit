 ...
 * Video editor state.
 *
 * The timeline mutations themselves live in `@layera-labs/orbit-video` — they are
...
import * as ops from '@layera-labs/orbit-video/browser';
import {
  projectDuration,
  type IdFactory,
  type VideoProject,
...
/*
 * The editing operations now live in `@layera-labs/orbit-video` — see `edit.ts` there
