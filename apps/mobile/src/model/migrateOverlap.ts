 ...
 *
 * VENDORED from `packages/video/src/migrate-overlap.ts` — mobile installs
 * outside the pnpm workspace. `__tests__/migrateOverlap.test.ts` compares the
 * OUTPUTS of the two copies; divergent clients against one synced document is a
