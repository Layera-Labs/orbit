...
export function EditorSheets() {
  ...
  return (
    <>
      ...
      {panel === 'textedit' && <TextSettingsSheet />}
...
const s = StyleSheet.create({
  ...
  teSizeCol: { paddingVertical: 4 },
  teSizeRow: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 16, height: 48 },
  teSizeLabel: { color: '#fff', fontSize: 14, fontFamily: font.medium, minWidth: 62 },
  teSizeVal: { color: '#fff', fontFamily: mono.regular, fontSize: 14, minWidth: 40, textAlign: 'right' },
