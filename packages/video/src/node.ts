 ...
 * so `@layera-labs/orbit-video/node` is a superset — a Node caller wants the timeline model
 ...
 * is the whole point of the split: a bundler following `@layera-labs/orbit-video` must
