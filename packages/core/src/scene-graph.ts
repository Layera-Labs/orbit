...
import { generateId } from '@layera-labs/orbit-shared';
import type { Layer, SceneGraph as SceneGraphType, BackgroundProps, CanvasBorder } from '@layera-labs/orbit-shared';
