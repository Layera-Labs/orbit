...
import { OrbitSidebar } from '@layera-labs/orbit-ui';
import { themeManager } from '@layera-labs/orbit-ui';
...
import type { AssetProvider, SceneGraph as SceneGraphState } from '@layera-labs/orbit-shared';
...
export interface OrbitEditorProps {
   ...
   * the editor used to construct `@layera-labs/orbit-agentic`'s client for this, which made
